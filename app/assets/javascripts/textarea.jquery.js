/*
	Plugin that simulates maxlength for textarea
	Features:
	- Validation on load
	- Validation on paste
	...
	- Allows CTRL + (...)
	- Only run keypress and paste functionality in case the browser does not support the maxlength to textarea (HTML 5)
	@param Object
	@return undefined
	@author Evandro L. Goncalves
*/
(function($){
	$.fn.textarea = function(options){
		var settings = {maxlength: 32768, visibleCount: false};
